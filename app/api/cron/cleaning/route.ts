...
// Scheduled via vercel.json at 04:30 Taiwan (20:30 UTC) — just after the
// business day rolls over at 04:00, so the duty is set before anyone opens.
// Also safe to call manually. Requires CRON_SECRET: Vercel Cron sends it as a
// Bearer token.
