...
export const BRANCHES: Branch[] = [
  {
    ...
    address: '桃園市平鎮區',
    staff_count: 3,
    image_url: '/images/branch4_pic.jpeg',
    is_active: true,
  },
  {
    id: '3',
...
export const SERVICES: Service[] = [
  { id: 'svc-main-solid', name: '單色', service_type: 'main', is_addon: false, is_active: true, duration_minutes: 60, price: 0 },
  { id: 'svc-main-cat-eye', name: '貓眼', service_type: 'main', is_addon: false, is_active: true, duration_minutes: 90, price: 0 },
  { id: 'svc-main-gradient', name: '漸層', service_type: 'main', is_addon: false, is_active: true, duration_minutes: 90, price: 0 },
  ...
  { id: 'svc-addon-thicken', name: '加厚', service_type: 'addon', is_addon: true, is_active: true, duration_minutes: 35, price: 0 },
  { id: 'svc-addon-extension', name: '延甲', service_type: 'addon', is_addon: true, is_active: true, duration_minutes: 60, price: 0 },
  { id: 'svc-addon-repair', name: '補甲', service_type: 'addon', is_addon: true, is_active: true, duration_minutes: 30, price: 0 },
]
