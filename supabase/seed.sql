...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ('sty-budian', 'svc-main-solid', 'hand', 60, NULL, false),
  ('sty-budian', 'svc-main-solid', 'foot', 40, NULL, false),
  ('sty-budian', 'svc-main-cat-eye', 'hand', 90, NULL, false),
  ('sty-budian', 'svc-main-cat-eye', 'foot', 60, NULL, false),
  ('sty-budian', 'svc-main-gradient', 'hand', 90, NULL, false),
  ('sty-budian', 'svc-main-gradient', 'foot', 60, NULL, false),
  ('sty-budian', 'svc-main-french', 'hand', 90, NULL, false),
  ('sty-budian', 'svc-main-french', 'foot', 80, NULL, false),
  ('sty-budian', 'svc-main-mirror', 'hand', 90, NULL, false),
  ('sty-budian', 'svc-main-mirror', 'foot', 90, NULL, false),
  ('sty-budian', 'svc-main-store-style', 'hand', 90, NULL, false),
  ('sty-budian', 'svc-main-store-style', 'foot', 90, NULL, false),
  ('sty-budian', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-budian', 'svc-main-custom-style', 'foot', 150, NULL, false),
  ('sty-budian', 'svc-addon-remove', 'hand', 30, NULL, false),
  ('sty-budian', 'svc-addon-remove', 'foot', 30, NULL, false),
  ('sty-budian', 'svc-addon-care', 'hand', 40, NULL, false),
  ('sty-budian', 'svc-addon-care', 'foot', 60, NULL, false),
  ('sty-budian', 'svc-addon-shape', 'hand', 20, NULL, false),
  ('sty-budian', 'svc-addon-shape', 'foot', 30, NULL, false),
  ('sty-budian', 'svc-addon-thicken', 'hand', 20, '加算時間 +20', false),
  ('sty-budian', 'svc-addon-thicken', 'foot', 20, '加算時間 +20', false),
  ('sty-budian', 'svc-addon-extension', 'hand', 60, '加算時間 +60', false),
  ('sty-budian', 'svc-addon-extension', 'foot', 60, '加算時間 +60', false)
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-tingting', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-tingting', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-niuniu', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-niuniu', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-ani', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-ani', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-xiaoe', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-xiaoe', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-xiaoq', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-xiaoq', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-summer', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-summer', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO service_durations (stylist_id, service_id, category, duration_minutes, duration_note, is_pending) VALUES
  ...
  ('sty-qiuqiu', 'svc-main-custom-style', 'hand', 150, NULL, false),
  ('sty-qiuqiu', 'svc-main-custom-style', 'foot', 150, NULL, false),
...
INSERT INTO bookings (
  ...
  (
    ...
    '[{"service_id":"svc-main-custom-style","service_name":"自帶圖款式","service_type":"main","category":"hand","duration_minutes":150}]'::JSONB,
    'hand', 150,
    CURRENT_DATE + 2, '11:00', '13:30', 'confirmed', '需要先看圖'
  ),
  (
